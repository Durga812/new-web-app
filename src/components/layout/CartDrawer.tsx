...
export function CartDrawer({ isOpen, onClose }: CartDrawerProps) {
  const { items, summary, itemCount } = { itemCount: 0, items: [], summary: null } //this will used later
        ...
        {isEmpty ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8">
            ...
            <div className="space-y-3 w-full max-w-xs">
              ...
              <Link href="/bundles" onClick={onClose} className=''>
          ...
          <>
            ...
            {summary && (
              <div className="border-t border-amber-200 bg-gradient-to-r from-amber-50/50 to-orange-50/50 p-6">
                {/* //multiple items added progress bar */}
